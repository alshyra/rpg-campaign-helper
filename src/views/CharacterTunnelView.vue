    ...
    <AppCard>
      <div class="grid gap-4 p-2">
        ...
        <div class="grid gap-2.5">
          ...
          >
            <div
              class="grid h-12 w-12 shrink-0 place-items-center rounded-xl border border-amber-500/20 bg-amber-950/50 font-(family-name:--serif) text-xl font-black text-amber-500"
            >
              {{ system.name[0] }}
            </div>
            <div>
            ...
            <ChevronRight
              class="ml-auto h-5 w-5 shrink-0 text-stone-700"
              :stroke-width="1.8"
            />
          </button>
        </div>
