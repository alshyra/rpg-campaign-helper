<template>
	<div class="app-shell relative min-h-screen">
		...
		<header v-if="showHeader" class="app-topbar sticky top-0 z-50 grid grid-cols-[40px_1fr_40px] items-center gap-3 border-b border-white/5 bg-black/60 px-5 py-4 backdrop-blur-md">
