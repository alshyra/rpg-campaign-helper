<template>
  <AppCard>
    <div class="radar-card grid place-items-center">
      <svg viewBox="0 0 260 260" class="radar-chart w-full max-w-80" role="img" aria-label="Radar des caractéristiques">
        <g transform="translate(130 130)">
          ...
          />
          <polygon :points="valuePoints" class="radar-chart__shape" />
          <circle
