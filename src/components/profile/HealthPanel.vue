  ...
  <div class="rounded-3xl border border-white/5 bg-stone-900/60 p-5 shadow-inner">
    ...
    <div class="mb-6 flex items-end justify-between px-1">
      <div class="space-y-1">
        ...
        <p
          class="m-0 font-(family-name:--serif) text-sm font-black italic tracking-wider transition-colors duration-500"
          :class="status.color"
        >
          {{ status.text }}
        </p>
    ...
    <div class="grid gap-3">
      <div
        ...
        :key="tier.key"
      >
        <span class="mb-2 block px-1 text-[9px] font-bold uppercase tracking-widest text-stone-500">{{
          tier.label
        }}</span>
